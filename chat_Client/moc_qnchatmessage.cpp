...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QNChatMessage_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QNChatMessage_t qt_meta_stringdata_QNChatMessage = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QNChatMessage[] = {
...
Q_CONSTINIT const QMetaObject QNChatMessage::staticMetaObject = { {
    ...
    qt_meta_stringdata_QNChatMessage.offsetsAndSizes,
    qt_meta_data_QNChatMessage,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QNChatMessage_t,
        // Q_OBJECT / Q_GADGET
