...
//        int screenY=desktop.availableGeometry().height()-40;
        QRect desktop;
        int screenX=desktop.width();
        int screenY=desktop.height()-40;
        int frmX=frm->width();
        int frmY=frm->height();
...
//        int screenY = qApp->desktop()->availableGeometry().height()-60;
        int screenX = qApp->primaryScreen()->availableGeometry().width();
        int screenY = qApp->primaryScreen()->availableGeometry().height()-60;
        int wndX = frm->width();
        int wndY = frm->height();
