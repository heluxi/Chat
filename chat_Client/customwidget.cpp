    ...
    CustomDialog(parent)
{
    ...
    labelWinIcon->setPixmap(QPixmap(":/res/robot.png"));
    ...
    btnWinMin->setIcon(QIcon(":/res/common/ic_close_white.png"));

    btnWinClose = new QPushButton(this);
    btnWinClose->setObjectName("btnWinClose");
    btnWinClose->setIcon(QIcon(":/res/common/ic_close_white.png"));
    ...
    CBaseDialog(parent)
{
    ...
    labelIcon->setPixmap(QPixmap(":/res/images/ic_info.png"));
...
void CMessageBox::ShowMessage(const QString &content, const quint8 &msgType, const QString &title)
{
    ...
    if (CMessageBox::E_Information == msgType)
        ...
        labelIcon->setPixmap(QPixmap(":/res/images/ic_warning.png"));
    else if (CMessageBox::E_Question == msgType)
        labelIcon->setPixmap(QPixmap(":/res/images/ic_question.png"));
    else
        labelIcon->setPixmap(QPixmap(":/res/images/ic_info.png"));
}
